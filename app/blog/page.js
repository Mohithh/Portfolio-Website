        ...
        <div className="relative pl-12 mb-16">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
            <div className="flex items-center mb-3">
              ...
              <div className="ml-auto flex gap-2">
                <Image src="https://img.shields.io/badge/Python-Love%20At%20First%20Sight-brightgreen" alt="Python" width={150} height={24} className="h-6 w-auto" />
                <Image src="https://img.shields.io/badge/Indentation--Matters-red" alt="Indentation" width={120} height={24} className="h-6 w-auto" />
              </div>
            </div>
            <p className="text-gray-700 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
              <div className="bg-green-100 p-3 rounded-lg text-center hover:scale-105 transition-transform">
                ...
                <Image src="https://img.shields.io/badge/smtplib-Used-yellowgreen" alt="smtplib" width={100} height={16} className="h-4 w-auto mx-auto mt-1" />
              </div>
              <div className="bg-green-100 p-3 rounded-lg text-center hover:scale-105 transition-transform">
                <span className="text-lg">🕵️</span>
                <p className="text-sm font-medium">Web scrapers</p>
                <Image src="https://img.shields.io/badge/BeautifulSoup4-Mastered-green" alt="BeautifulSoup" width={130} height={16} className="h-4 w-auto mx-auto mt-1" />
              </div>
              <div className="bg-green-100 p-3 rounded-lg text-center hover:scale-105 transition-transform">
                <span className="text-lg">📊</span>
                <p className="text-sm font-medium">Data visualizers</p>
                <Image src="https://img.shields.io/badge/Matplotlib-Artist-blue" alt="Matplotlib" width={100} height={16} className="h-4 w-auto mx-auto mt-1" />
              </div>
            </div>
        ...
        <div className="relative pl-12 mb-16">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
            <div className="flex items-center mb-3">
              ...
              <div className="ml-auto flex gap-2">
                <Image src="https://img.shields.io/badge/JS-Callback%20Hell-yellow" alt="JavaScript" width={120} height={24} className="h-6 w-auto" />
                <Image src="https://img.shields.io/badge/DOM-Manipulation-blue" alt="DOM" width={110} height={24} className="h-6 w-auto" />
              </div>
            </div>
            <p className="text-gray-700 mb-4">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm flex items-center">
                ...
                <Image src="https://img.shields.io/badge/LocalStorage-Used-lightgrey" alt="LocalStorage" width={110} height={16} className="h-4 w-auto ml-1" />
              </span>
              <span className="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm flex items-center">
                <span className="mr-1">⏱️</span> Pomodoro timers
                <Image src="https://img.shields.io/badge/setInterval-Abused-red" alt="setInterval" width={100} height={16} className="h-4 w-auto ml-1" />
              </span>
              <span className="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm flex items-center">
                <span className="mr-1">🌦️</span> Weather apps
                <Image src="https://img.shields.io/badge/API-Fetched-blue" alt="API" width={80} height={16} className="h-4 w-auto ml-1" />
              </span>
            </div>
            <p className="text-gray-700">
        ...
        <div className="relative pl-12 mb-16">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
            <div className="flex items-center mb-3">
              ...
              <div className="ml-auto flex gap-2">
                <Image src="https://img.shields.io/badge/React-Hooks%20Lover-blue" alt="React" width={130} height={24} className="h-6 w-auto" />
                <Image src="https://img.shields.io/badge/JSX-Converted-yellow" alt="JSX" width={100} height={24} className="h-6 w-auto" />
              </div>
            </div>
            <p className="text-gray-700 mb-4">
            ...
            <ul className="list-disc pl-5 text-gray-700 space-y-2 mb-4">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <Image src="https://img.shields.io/badge/useState-Conquered-purple" alt="useState" width={100} height={16} className="h-4 w-auto ml-2 inline" />
                </div>
              </li>
              <li className="flex items-start">
                <span className="mr-2">🛒</span>
                <div>
                  ...
                  <Image src="https://img.shields.io/badge/Prop%20Drilling-Suffered-red" alt="Prop Drilling" width={120} height={16} className="h-4 w-auto ml-2 inline" />
                </div>
              </li>
              <li className="flex items-start">
                <span className="mr-2">🔀</span>
                <div>
                  ...
                  <Image src="https://img.shields.io/badge/Redux--Not%20Needed-success" alt="Context API" width={130} height={16} className="h-4 w-auto ml-2 inline" />
                </div>
              </li>
            </ul>
            <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
            ...
            <div className="mb-6 p-4 bg-purple-50 rounded-lg border-l-4 border-purple-400 hover:bg-purple-100 transition-colors">
              <h4 className="font-bold text-purple-700 mb-2 flex items-center">
                ...
                <Image src="https://img.shields.io/badge/CommonJS-Required-blue" alt="CommonJS" width={120} height={20} className="h-5 w-auto ml-auto" />
              </h4>
            ...
            <div className="mb-6 p-4 bg-purple-50 rounded-lg border-l-4 border-purple-400 hover:bg-purple-100 transition-colors">
              <h4 className="font-bold text-purple-700 mb-2 flex items-center">
                ...
                <Image src="https://img.shields.io/badge/Middleware-Magic-9cf" alt="Middleware" width={110} height={20} className="h-5 w-auto ml-auto" />
              </h4>
              <p className="text-gray-700 mb-3">
            ...
            <div className="p-4 bg-purple-50 rounded-lg border-l-4 border-purple-400 hover:bg-purple-100 transition-colors">
              <h4 className="font-bold text-purple-700 mb-2 flex items-center">
                ...
                <Image src="https://img.shields.io/badge/NoSQL-Flexible-green" alt="NoSQL" width={90} height={20} className="h-5 w-auto ml-auto" />
              </h4>
              <p className="text-gray-700">
        ...
        <div className="relative pl-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all bg-gradient-to-br from-gray-50 to-gray-100">
            <div className="flex items-center mb-3">
              ...
              <div className="ml-auto flex gap-2">
                <Image src="https://img.shields.io/badge/SSR-Learned-blue" alt="SSR" width={90} height={24} className="h-6 w-auto" />
                <Image src="https://img.shields.io/badge/API%20Routes-Loved-green" alt="API Routes" width={110} height={24} className="h-6 w-auto" />
              </div>
            </div>
            <p className="text-gray-700 mb-4">
              ...
              <ul className="list-disc pl-5 text-gray-700 space-y-1">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <Image src="https://img.shields.io/badge/No%20More%20React%20Router-blue" alt="Routing" width={150} height={16} className="h-4 w-auto ml-1 inline" />
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="mr-1">🚫</span>
                  <div>
                    ...
                    <Image src="https://img.shields.io/badge/API%20Routes-Solved%20It-success" alt="API Routes" width={120} height={16} className="h-4 w-auto ml-1 inline" />
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="mr-1">⚡</span>
                  <div>
                    ...
                    <Image src="https://img.shields.io/badge/Image%20Optimization-Awesome-blue" alt="Image Opt" width={150} height={16} className="h-4 w-auto ml-1 inline" />
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-16 text-center bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-2xl border-2 border-dashed border-blue-200">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-6">
            <span className="bg-white px-4 py-2 rounded-full shadow-sm text-sm font-medium flex items-center">
              ...
              <Image src="https://img.shields.io/badge/Types-Safe-blue" alt="TypeScript" width={80} height={16} className="h-4 w-auto ml-1" />
            </span>
            <span className="bg-white px-4 py-2 rounded-full shadow-sm text-sm font-medium flex items-center">
              <span className="mr-1">🐳</span> Docker
              <Image src="https://img.shields.io/badge/Containers-Magic-blue" alt="Docker" width={100} height={16} className="h-4 w-auto ml-1" />
            </span>
            <span className="bg-white px-4 py-2 rounded-full shadow-sm text-sm font-medium flex items-center">
              <span className="mr-1">☁️</span> AWS
              <Image src="https://img.shields.io/badge/Cloud-Expensive-orange" alt="AWS" width={100} height={16} className="h-4 w-auto ml-1" />
            </span>
            <span className="bg-white px-4 py-2 rounded-full shadow-sm text-sm font-medium flex items-center">
              <span className="mr-1">📡</span> GraphQL
              <Image src="https://img.shields.io/badge/Overfetching-Solved-pink" alt="GraphQL" width={110} height={16} className="h-4 w-auto ml-1" />
            </span>
          </div>
          <p className="text-gray-600 flex items-center justify-center">
            <Image src="https://img.shields.io/badge/Next%20Stop-Full%20Stack%20Mastery-purple" alt="Next Stop" width={180} height={24} className="h-6 w-auto mr-2" />
